...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "brooklyn@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Club": {
        "description": "Rehearse and perform plays, improv, and theater pieces",
    ...
    "Debate Team": {
        "description": "Practice public speaking and debate topics with peers",
